...
class LineByLineTextDataset(Dataset):
    ...
    def __init__(self, tokenizer, file_path, max_instances=None, rap_prob=0.0):
        # print(file_path)
        ...
        batch_encoding = tokenizer(self.lines)
        self.examples = batch_encoding["input_ids"]
        self.end_positions = batch_encoding["end_positions"]
        self.canonical_lengths = batch_encoding["canonical_lengths"]
    ...
    def get_seq_len(self):
        return [(len(example), idx) for idx, example in enumerate(self.examples)]
    ...
    def __getitem__(self, i):
        ...
        output_dict['canonical_lengths'] = self.canonical_lengths[i]
